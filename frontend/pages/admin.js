...
//     try {
//       const res = await axios.get("http://localhost:5000/api/leaves", { headers: getHeaders() });
//       setLeaves(res.data);
//     } catch { router.push("/"); }
//   };
...
//     setLoading(true);
//     await axios.put(`http://localhost:5000/api/leaves/${id}`, { status }, { headers: getHeaders() });
//     fetchLeaves();
//     setLoading(false);
//   };
...
//   await axios.delete("http://localhost:5000/api/leaves/clear-all", { headers: getHeaders() });
//   fetchLeaves();
// };
